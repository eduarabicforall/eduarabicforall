  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        <div className="w-20 h-20 bg-primary/15 rounded-3xl flex items-center justify-center text-4xl mb-6">
          🌙
        </div>
        ...
        <div className="flex flex-col gap-3 w-full max-w-xs">
          <Link
            to="/auth"
            className="py-3.5 bg-primary text-bg rounded-2xl font-semibold text-sm text-center hover:bg-primary/90 active:scale-[0.98] transition-all"
          >
            Get started free →
          </Link>
          <Link
